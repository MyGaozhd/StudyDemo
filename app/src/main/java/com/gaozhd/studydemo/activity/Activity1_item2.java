 ...
 * 
 */
public class Activity1_item2 extends Activity1_BaseActivity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		case R.id.btn1:
			...
			break;
		case R.id.btn2:
			Intent intent = new Intent(Activity1_item2.this, Broadcast1.class);
			sendBroadcast(intent);
			break;
		case R.id.btn3:
			Intent intent1 = new Intent(Activity1_item2.this,
	...
	public void changePf() {
		try {
			iv.setImageBitmap(BitmapFactory.decodeStream(Activity1_item2.this
