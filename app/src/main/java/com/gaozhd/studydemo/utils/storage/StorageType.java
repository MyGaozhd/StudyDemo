package com.gaozhd.studydemo.utils.storage;
...
public enum StorageType {
    ...
    TYPE_HOTFIX(DirectoryName.HOTFIX_DIRECTORY_NAME),
    TYPE_TIANTAN(DirectoryName.TIANTAN_DIRECTORY_NAME),
    ...
    enum DirectoryName {     	
        ...
        HOTFIX_DIRECTORY_NAME("hotfix/"),
        TIANTAN_DIRECTORY_NAME("tiantan/"),
